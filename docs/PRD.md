...
>
> ⚠️ **2026-09-25 v3 切型状态**：本文件的需求铁律（场景必选 / 澄清有界 / 不臆造 / 确认后才审批）继续有效；
> 实现层已按 `docs/重构-v3-agent原生-蓝图.md` 推倒重建为 Agent 原生单服务（core），文中提到的
> journey-hub / planner-core / sense-engine 三服务与网关装配已退役。感知外接服务（第二份 PRD 的 R1/R2/R5/R7）
> 待工具化插装。
